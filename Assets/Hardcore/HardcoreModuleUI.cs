...
public class HardcoreModuleUI : UIState
{
	...
	public override void Update(GameTime gameTime)
	{
		...
		worldDeathsText.SetText(config.EnableMaximumLivesPerWorld
			? $"World: {worldDeaths} / {maxWorldDeaths}"
			: "");
		playerDeathsText.SetText(config.EnableMaximumLivesPerPlayer
			? $"Player: {thisPlayerDeaths} / {maxPlayerDeaths}"
			: "");
